...
const guidance = {
  ...
  homeo: {
    ...
    actions: [
      ...
      "Try a 2‑min gratitude pause to reinforce stability."
    ]
  },
  low: {
...
function renderQuestion(){
  ...
  /* Make three buttons fresh each time so their labels match opts */
  buttonsWrap.innerHTML = "";
  [-1,0,1].forEach((score,i)=>{
...
function finishTest(){
  ...
  hide(questionCard); renderResult(total); show(resultCard);
}
